...
def customer_preference():
    st.title("Allocazione e guadagni con 'customer preference'")
...
def price():
    hotel_ex, guest_ex, preferences_ex = carica_file()
    st.title("Allocazioni e guadagni con 'price'")
    hotel_ex['stanze_disponibili']=hotel_ex['rooms'].copy()
...
# Selettore di modulo
metodo_selezionato = st.selectbox("Seleziona il metodo da visualizzare", ("random", "customer_preference", "price"))
